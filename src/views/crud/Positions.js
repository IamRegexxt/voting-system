...
const Positions = () => {
  const style = {
    ...
    const fetchElection = async () => {
        await axios.get('https://amorganda.tech/public/api/elections', { headers: headers },
        {
            headers: headers
        }).then(({ data }) => {
            setElection(data)
    ...
    const updatePosition = async (id,position_code,position_name,users_id, election_id) => {
    ...
    const updatePositionInfo = async (e) => {
      ...
      formData.append('election_id', election_id);
        ...
        await axios.put(`https://amorganda.tech/public/api/position/${id}`, formData, { headers: headers }).then(({ data }) => {
          Swal.fire({
      ...
      await axios.delete(`https://amorganda.tech/public/api/position/${id}`, { headers: headers }).then(({ data }) => {
          Swal.fire({
      ...
      const createPositionModal = () => {
        ...
        const createPosition = async (e) => {
          ...
          await axios.post('https://amorganda.tech/public/api/position', formData, { headers: headers }).then(({ data }) => {
        ...
        <TableHead>
          <TableRow>
            ...
            <TableCell style={{fontSize: '22px'}}><center><strong>Action
              <Button variant="contained" onClick={createPositionModal}>Create</Button>
              </strong></center>
            </TableCell>
          </TableRow>
        </TableHead>
                ...
                return (
                  <TableRow key={key} style={{textAlignLast: 'center'}} >
                    ...
                    <TableCell style={{ fontSize: '20px' }}><center>
                      <Button color="secondary" onClick={() => readPosition(column.id, column.position_code, column.position_name, election.election_description)}>
                        Read
                      </Button>
                      <Button variant="contained" color="success" onClick={() => updatePosition(column.id, column.position_code, column.position_name, column.users_id, column.election_id)}>
                        Update
                      </Button>
                      <Button variant="outlined" color="error" onClick={() => deletePosition(column.id)}>
                        Delete
                      </Button>
                    </center></TableCell>
                  </TableRow>
